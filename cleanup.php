...
{
    global $db_helper;
    $file_path = ($photo['file_id']==NULL?Config::PHOTOS_TMP_DIR:Config::PHOTOS_SRV_DIR) . DIRECTORY_SEPARATOR . $photo['file_id'] . $photo['file_ext'];
    $success = unlink($file_path);
    if($success) $db_helper->deletePhoto($photo['file_id']);
